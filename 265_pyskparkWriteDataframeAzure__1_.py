...
spark = SparkSession\
    ...
    .config("spark.yarn.access.hadoopFileSystems",\
            "abfs://data@cpvtwo.dfs.core.windows.net/warehouse")\
    .getOrCreate()
...
!hadoop fs -rm -r abfs://data@cpvtwo.dfs.core.windows.net/warehouse/martyparquet

#df.write.parquet("s3a://cdp-sandbox-default-se/datalake/martyparquet")
df.write.parquet("abfs://data@cpvtwo.dfs.core.windows.net/warehouse/martyparquet")
...
!hadoop fs -ls abfs://data@cpvtwo.dfs.core.windows.net/warehouse/
